(function (root, factory) {
   ...
   * value.
   */
  var min = function (minimum, customMsg) {
   ...
   * value.
   */
  var max = function (maximum, customMsg) {
    return predicateTest("Value was greater than the expected minimum", function (value) {
   ...
   */
  var strEnum = function (values, customMsg) {
  ...
  var or = function (v1, v2) {
    return function (value) {
      return v1.run(value, false)
        .then(function (xresult) {
          if (!xresult.valid) return v2.run(value, false);
          return xresult;
        });
    };
  };
