(function (root, factory) {
  ...
  var nonEmpty = function (v, rules) {
    return function (customMsg) {
      ...
      rules.push(function (xs) {
        return handleTest(xs.length > 0, msg);
      });
      return v;
    };
  };
  ...
  var create = function () {
    ...
    v.obj = function (customMsg) {
      ...
      return simpleTest(typeTests.isObject, "Value is not an object")(v, rules)(customMsg);
    ...
    v.arr = function (customMsg) {
      ...
      return simpleTest(typeTests.isArray, "Value is not an array")(v, rules)(customMsg);
